...
namespace QLNS.View
{
    public partial class frmUpdate : Form
    {
        ...
        private void btnSua_Click_1(object sender, EventArgs e)
        {
            ...
            lst= control.Convert(da.Query("dbo.Getten", new SqlParameter("@ten", cbbmachucvu.Text)));
            nv.maChucVu = lst[0].ToString();
            lst = control.Convert(da.Query("dbo.GettenL", new SqlParameter("@luongcoban", cbbmaluong.Text)));
            nv.maluong = lst[0].ToString();
            lst = control.Convert(da.Query("dbo.GettenPB", new SqlParameter("@ten", cbbmaphongban.Text)));
            nv.maphongban = lst[0].ToString();
            lst = control.Convert(da.Query("dbo.GettenTDHV", new SqlParameter("@ten", cbbmatdhv.Text)));
            nv.maTDHV = lst[0].ToString();
            control.Sua(nv.ma, nv.ten, nv.diachi, nv.ngaysinh, nv.gioitinh, nv.socmnd, nv.dienthoai, nv.email, nv.maChucVu, nv.maluong, nv.maphongban, nv.maTDHV);
            MessageBox.Show("Thành công");
            //   }
            //  else
